							...
							<td>
								...
								<div class="pagination">
									...
									<!-- 跳转上一页功能实现 -->
										...
										<!-- 跳转下一页功能实现 -->
										<c:if test="${pageResult.currentPage == pageResult.totlaPage}">
											<li class="disablepage">下一页&gt;&gt;</li>
										</c:if>
										<c:if test="${pageResult.currentPage != pageResult.totlaPage}">
										<li class="nextpage"><a href="${pageContext.request.contextPath }/showProductByPage?category=${category}&page=${pageResult.currentPage + 1}"">下一页&gt;&gt;</a></li>
										</c:if>
